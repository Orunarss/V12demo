...
class EmployeOrder(models.TransientModel):
    ...
    def action_print(self):
        ...
        action=  self.env.ref('abs_maintenance_summary.maintenance_request_report')\
    ...
    def _print_report(self,data):
        return self.env.ref('abs_maintenance_summary.maintenance_request_report').report_action(self, data=data, config=False)
